...
then take a look at the structure of our dataset and summarize the variables it contains
...
The numeric variable _dose_ contains 3 unique values---> (0.5, 1, 2)convert it to a factor variable with three levels
...
A multiplanel plot emphasizes the relationship between teeth length and dose level for each type. It appears to be a positive relationship for both supplement types. Therefore, when the amount of supplement increases, so does teeth length.
...
Thus, at dosage level 2, VC is more effective than OJ, with an average teeth length of 26.14 V 26.06
...
there appears to be a positive relationship between dose level and teeth length
